                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">Tổng lượt đọc</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->max_read}}</td>
                                <td>
                                    <a href="{{route('admin.edit_level_admin',$item->id)}}"
                                        class="btn btn-primary">Sửa</a>
                                    <form class="d-inline" method="POST" action="{{route('admin.delete_level_admin')}}">
                                        @csrf
