...
<body class="ltr app sidebar-mini">
    ...
    @if(session('warning'))
    <div style="z-index: 9999; bottom:50px; left: 30px; position:fixed" id="alert1" class="alert alert-warning">
        {{ session('warning') }}
    </div>
    @endif
    <!-- GLOBAL-LOADER -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="" data-bs-toggle="dropdown"
                                                ...
                                                <span>
                                                    @if(session('admin') && session('admin')->avatar != null)
                                                    <img src="{{asset('imgs/'. session('admin')->avatar)}}"
                                                        alt="profile-user"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{route('admin.manage_user_admin')}}">
                                                ...
                                                <a class="dropdown-item" href="{{route('admin.logout_admin')}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Quản lý quản trị viên</span><i
                                        class="angle fa fa-angle-right"></i>
                                </a>
                                <ul class="slide-menu">
                                    <!-- <li class="side-menu-label1"><a href="javascript:void(0)">Forms</a></li> -->
                                    <li><a href="{{route('admin.list_user_admin')}}" class="slide-item">Danh sách quản
                                            trị viên</a></li>
                                    <li><a href="{{route('admin.add_user_admin')}}" class="slide-item">Thêm quản trị
                                            viên</a>
                                    </li>
                                </ul>
                            </li>
    ...
    <script src="{{asset('assets/alert/scripts.js')}}"></script>
