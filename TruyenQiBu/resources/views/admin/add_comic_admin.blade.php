    ...
    <div class="col-lg-12">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Thêm Truyện</h1>
                </div>
            ...
            <div class="row ">
                <div class="col-md-12">
                    <div class="px-3 card">
                        ...
                        <form class="card-body" method="POST" action="{{ route('admin.store_comic_admin') }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6 my-1">
                                    ...
                                    <select class="form-control select2-show-search form-select" name="status_comic_id"
                                ...
                                <div>
                                    <div class="control-group form-group">
                                        ...
                                        <textarea id="name-wiz1" class="form-control" name="description"
                                            placeholder="Mô tả truyện" required></textarea>
                                    </div>
                                </div>
                            </div>
